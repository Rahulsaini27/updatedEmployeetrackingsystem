...
urlpatterns = [
    ...
    # path('create-role', av.create_role),
    # path('read-role', av.read_roles),
    # path('delete-role/<int:pk>/', av.delete_role),

    # path('create-permission', av.create_permission),
    # path('read-permission', av.read_permissions),
    path('create-role', av.create_role, name='create-role'),
    path('read-role', av.read_roles, name='read-roles'),
    path('update-role/<int:pk>/', av.update_role, name='update-role'),
    path('delete-role/<int:pk>/', av.delete_role, name='delete-role'),
    path('create-permission', av.create_permission, name='create-permission'),
    path('read-permission', av.read_permissions, name='read-permissions'),
    path('update-permission/<int:pk>/', av.update_permission, name='update-permission'),
    path('delete-permission/<int:pk>/', av.delete_permission, name='delete-permission'),
